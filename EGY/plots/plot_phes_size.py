...
RE_Share = [10, 20, 30, 40, 50, 60, 70, 80, 90, 105]
RE_Share_ticks = [20,40,60,80, 100]
x_values = range(len(RE_Share))
fmt = '%.0f%%'
yticks = mtick.FormatStrFormatter(fmt)

fig, ((ax1, ax2, ax14), (ax3,ax5, ax16))= plt.subplots(2,3, figsize=(56.56,53.33), sharex=False)

fig.suptitle('Calliope Operation: Egypt', fontweight='bold', fontsize=80)
...
ax7.plot(x3, y3, color='#bd7ce6' ,linewidth=8,label='PHES', marker='o', zorder=3) #lilla
ax7.plot(x4, y4, color='#8300d4' ,linewidth=12,label='PHES and TE', marker='o', zorder=1) #viola
...
ax7.scatter(marker_x_Solar, marker_y_Solar_PH, color='#bd7ce6', s=1500, zorder=3)
ax7.scatter(marker_x_Solar, marker_y_Solar_PH_exp, color='#8300d4', s=3000, zorder=1)
...
ax7.set_ylim(10,1.05*average_supply)
...
ax8.plot(x7, y7, color='#bd7ce6' ,linewidth=8, label='PHES', marker='o', zorder=3) #lilla
ax8.plot(x8, y8, color='#8300d4' ,linewidth=12,label='PHES and TE', marker='o', zorder=1) #viola

ax8.scatter(marker_x_Wind, marker_y_Wind_Base, color='#64b551', s=1500, zorder=3)
ax8.scatter(marker_x_Wind, marker_y_Wind_Base_exp, color='#055e24', s=3000)
ax8.scatter(marker_x_Wind, marker_y_Wind_PH, color='#bd7ce6', s=1500, zorder=3)
ax8.scatter(marker_x_Wind, marker_y_Wind_PH_exp, color='#8300d4', s=3000, zorder=1)
...
ax8.set_ylim(10,1.05*average_supply)
ax8.set_xlim(5,95)
...
ax15 = ax14.twinx()
ax15.plot(x10, y1,color='#64b551', linewidth=8, marker='o', markersize=1, label='RO', zorder=3) #verde
ax15.plot(x11, y2,color='#055e24', linewidth=12, marker='o', markersize=1,label='TE', zorder=1) #verde chiaro
ax15.plot(x12, y3, color='#bd7ce6' ,linewidth=8,  marker='o', markersize=1, label=f'PHES', zorder=3) #lilla
ax15.plot(x13, y4, color='#8300d4' ,linewidth=12, marker='o', markersize=1, label=f'PHES and TE', zorder=1) #viola

ax15.scatter(marker_x_SW, marker_y_RE_Base, color='#64b551', s=1500, zorder=3)
ax15.scatter(marker_x_SW, marker_y_RE_Base_exp, color='#055e24', s=3000, zorder=1)
ax15.scatter(marker_x_SW, marker_y_RE_PH, color='#bd7ce6', s=1500, zorder=3)
ax15.scatter(marker_x_SW, marker_y_RE_PH_exp, color='#8300d4', s=3000, zorder=1)
...
ax15.set_ylim(0, 1.05*average_supply)
