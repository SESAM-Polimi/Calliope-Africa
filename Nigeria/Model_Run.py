...
for cap in capacity:
    for sh in share:
        ...
        Location_Constraints['locations']['NGA_E']['techs']['PV']['constraints']['energy_cap_equals']=Solar_cap
        Location_Constraints['locations']['NGA_E']['techs']['Wind']['constraints']['energy_cap_equals']=Wind_cap
