...
input_yaml_path = 'Storage_BESS.yaml'  # Replace with the actual file path
yaml = YAML()
...
for scenario_name in scenario_names:
    ...
    storage_data = storage_data[(storage_data['techs'].str.contains("BESS", na=False)) & (storage_data['energy_cap'] != 0)]
