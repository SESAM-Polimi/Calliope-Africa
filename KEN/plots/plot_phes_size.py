...
main_folder_Base = f'Results/RO/30%Solar_70%Wind'
...
main_folder_Base = f'Results/TE/30%Solar_70%Wind'
...
main_folder_PH = f'Results/PHES/30%Solar_70%Wind'
...
main_folder_PH = f'Results/PHES_TE/30%Solar_70%Wind'
...
main_folder_PH = 'Results/Minimized_PHES/PHES/30%Solar_70%Wind_PHES_min'
...
main_folder_PH = 'Results/Minimized_PHES/PHES_TE/30%Solar_70%Wind_PHES_min'
...
Solar_cap_Base = [x for x in Solar_cap_Base if x <= 2.25 and x>=0.25]
Solar_cap_Base_exp = [x for x in Solar_cap_Base_exp if x <= 2.25 and x>=0.25]
Solar_cap_PH = [x for x in Solar_cap_PH if x <= 2.25 and x>=0.25]
Solar_cap_PH_exp = [x for x in Solar_cap_PH_exp if x <= 2.25 and x>=0.25]
Solar_cap_Min = [x for x in Solar_cap_Min if x <= 2.25 and x>=0.25]
Solar_cap_Min_exp = [x for x in Solar_cap_Min_exp if x <= 2.25 and x>=0.25]
...
Solar_cap_Base = [round(value, 2) for value in Solar_cap_Base]
Solar_cap_Base_exp = [round(value, 2) for value in Solar_cap_Base_exp]
Solar_cap_PH = [round(value, 2) for value in Solar_cap_PH]
Solar_cap_PH_exp = [round(value, 2) for value in Solar_cap_PH_exp]
Solar_cap_Min = [round(value, 2) for value in Solar_cap_Min]
Solar_cap_Min_exp = [round(value, 2) for value in Solar_cap_Min_exp]

marker_x_Solar = [0.25, 0.75, 1.25, 1.75,2.25]
...
Wind_cap_Base = [x for x in Wind_cap_Base if x <= 2.25 and x>=0.25]
Wind_cap_Base_exp = [x for x in Wind_cap_Base_exp if x <= 2.25 and x>=0.25]
Wind_cap_PH = [x for x in Wind_cap_PH if x <= 2.25 and x>=0.25]
Wind_cap_PH_exp = [x for x in Wind_cap_PH_exp if x <= 2.25 and x>=0.25]
Wind_cap_Min = [x for x in Wind_cap_Min if x <= 2.25 and x>=0.25]
Wind_cap_Min_exp = [x for x in Wind_cap_Min_exp if x <= 2.25 and x>=0.25]
...
Wind_cap_Base = [round(value, 2) for value in Wind_cap_Base]
Wind_cap_Base_exp = [round(value, 2) for value in Wind_cap_Base_exp]
Wind_cap_PH = [round(value, 2) for value in Wind_cap_PH]
Wind_cap_PH_exp = [round(value, 2) for value in Wind_cap_PH_exp]
Wind_cap_Min = [round(value, 2) for value in Wind_cap_Min]
Wind_cap_Min_exp = [round(value, 2) for value in Wind_cap_Min_exp]

marker_x_Wind = [0.25, 0.75, 1.25, 1.75,2.25]
...
#%% resize SW
RE_cap_Base = [x for x in RE_cap_Base if x <= 2.25 and x>=0.25]
RE_cap_Base_exp = [x for x in RE_cap_Base_exp if x <= 2.25 and x>=0.25]
RE_cap_PH = [x for x in RE_cap_PH if x <= 2.25 and x>=0.25]
RE_cap_PH_exp = [x for x in RE_cap_PH_exp if x <= 2.25 and x>=0.25]
RE_cap_PH_Min = [x for x in RE_cap_PH_Min if x <= 2.25 and x>=0.25]
RE_cap_PH_Min_exp = [x for x in RE_cap_PH_Min_exp if x <= 2.25 and x>=0.25]
...
RE_cap_Base = [round(value, 2) for value in RE_cap_Base]
RE_cap_Base_exp = [round(value, 2) for value in RE_cap_Base_exp]
RE_cap_PH = [round(value, 2) for value in RE_cap_PH]
RE_cap_PH_exp = [round(value, 2) for value in RE_cap_PH_exp]
RE_cap_PH_Min = [round(value, 2) for value in RE_cap_PH_Min]
RE_cap_PH_Min_exp = [round(value, 2) for value in RE_cap_PH_Min_exp]

marker_x_SW = [0.25, 0.75, 1.25, 1.75,2.25]
...
RE_Share = [10, 20, 30, 40, 45]
RE_Share_ticks = [10,20,30,40, 50]
...
fig.suptitle('Calliope Operation: Kenya', fontweight='bold', fontsize=80)
...
ax7.plot(x2, y2,color='#055e24', linewidth=12, label='TE', marker='o', zorder=1) #verde chiaro
ax7.plot(x3, y3, color='#bd7ce6' ,linewidth=8,label='PHES', marker='o') #lilla
ax7.plot(x4, y4, color='#8300d4' ,linewidth=8,label='PHES and TE', marker='o') #viola

ax7.scatter(marker_x_Solar, marker_y_Solar_Base, color='#64b551', s=1500, zorder=3)
ax7.scatter(marker_x_Solar, marker_y_Solar_Base_exp, color='#055e24', s=3000, zorder=1)
ax7.scatter(marker_x_Solar, marker_y_Solar_PH, color='#bd7ce6', s=2000)
...
ax7.set_ylim(0,0.45*average_supply)
...
ax8.plot(x5, y5,color='#64b551', linewidth=8, label='RO', marker='o', zorder=3) #verde
ax8.plot(x6, y6,color='#055e24', linewidth=12, label='TE', marker='o', zorder=1) #verde chiaro
...
ax8.scatter(marker_x_Wind, marker_y_Wind_Base, color='#64b551', s=1500, zorder=3)
ax8.scatter(marker_x_Wind, marker_y_Wind_Base_exp, color='#055e24', s=3000, zorder=1)
...
ax8.set_ylim(0,0.45*average_supply)
ax8.set_xlim(0, 2.5)
...
ax15.set_title('Optimal mix: 30% Solar, 70% Wind',  fontweight='bold',fontsize=60, pad=50)
...
ax15.set_ylim(0, 0.45*average_supply)
...
ax3.bar(marker_x_Solar, Solar_PHES_size, color='#5c7ce6',width=0.2, label='PHES size')
...
ax4.yaxis.set_major_locator(ticker.MultipleLocator(base=1))
...
ax5.bar(marker_x_Wind, Wind_PHES_size, color='#5c7ce6',width=0.2, label='PHES size')
...
ax6.yaxis.set_major_locator(ticker.MultipleLocator(base=1))
...
ax16.bar(marker_x_SW, SW_PHES_size, color='#5c7ce6',width=0.2, label='PHES size')
...
ax17.yaxis.set_major_locator(ticker.MultipleLocator(base=1))
...
ax9.bar(marker_x_Solar, Solar_exp_PHES_size, color='#5c7ce6',width=0.2, label='PHES size')
...
ax11.bar(marker_x_Wind, Wind_exp_PHES_size, color='#5c7ce6',width=0.2, label='PHES size')
...
ax18.bar(marker_x_SW, SW_exp_PHES_size, color='#5c7ce6',width=0.2, label='PHES size')
...
ax19.yaxis.set_major_locator(ticker.MultipleLocator(base=1))
