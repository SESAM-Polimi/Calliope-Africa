...
gen_techs = ['Coal', 'OCGT', 'Nuclear', 'Wind', 'Wind_added', 'PV', 'PV_added', 'CSP', 
             'Bioenergy', 'Hydro_Large', 'Hydro_Small']  

#technologies added 
added_techs = ['PV_added', 'Wind_added']

#location of added technolgies
PV_added_loc = 'SA_WSTR'
Wind_added_loc = 'SA_CSTR'

#select deseried capacity values and shares for which the minimum PHES size needs to be calculated
shares=[0, 1]
capacity_values=list(range(10000,91000,10000)) +[100000, 120000]
