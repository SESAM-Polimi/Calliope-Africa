...
strategy_definition = {
    ...
    'PHES': {'model_file': 'model_transmission.yaml', 'PHES_cap': 150000000, 'PHES_en': 900000000},       #PHES capacity and energy in kW
    'PHES_TE': {'model_file': 'model_transmission_exp.yaml', 'PHES_cap': 150000000, 'PHES_en': 900000000} #PHES capacity and energy in kW
}
...
for strategy in integration_strategies:
    ...
    for cap in capacity:
        for sh in share:
            ...
            Location_Constraints['locations']['SA_WSTR']['techs']['PV_added']['constraints']['energy_cap_equals']=Solar_cap
            Location_Constraints['locations']['SA_CSTR']['techs']['Wind_added']['constraints']['energy_cap_equals']=Wind_cap
            Location_Constraints['locations']['SA_CSTR']['techs']['PHES_added']['constraints']['energy_cap_equals']=PHES_cap
            Location_Constraints['locations']['SA_CSTR']['techs']['PHES_added']['constraints']['storage_cap_equals']=PHES_en
